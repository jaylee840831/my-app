...
export const profile: Profile = {
  ...
  experience: [
    ...
    {
      title: '悅慶資訊有限公司 Java後端工程師',
      desc: '2022/5~2022/11',
    },
    {
      title: '思納捷科技股份有限公司 Java後端工程師',
      desc: '2021/10~2022/4',
    },
    {
      title: '歐格電子工業股份有限公司 Android App工程師',
      desc: '2019/6~2019/11',
    },
  ],
  expertise: [
  ...
  introduce:
    '各位好，我是李尹覺，專業為軟體開發設計，專注於打造高效能與可擴展的網站系統。具備網頁、App獨立開發經驗，並且持續學習新技術，致力於提供穩定且具商業價值的解決方案。',
  swiperImage: [
    '/Personal.jpg',
    '/Personal2.jpg',
    '/Personal3.jpg',
